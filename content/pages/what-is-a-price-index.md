...
The price index calculation methodology has five parts: select a base period, collect comparable price observations, calculate product-level indices, aggregate with weights, and interpret movement relative to the base value of 100.
...
A normalised price index, also spelled normalized price index, rescales the index to a 0–100 or 0–1 range relative to a specific time window:
