...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w0.json"
CANDIDATES_FILE = "data/us_shopify_batch_0.json"
LOG_FILE = f"data/shopify-batch-w0-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
