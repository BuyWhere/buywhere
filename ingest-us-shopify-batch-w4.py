...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w4.json"
CANDIDATES_FILE = "data/us_shopify_batch_4.json"
LOG_FILE = f"data/shopify-batch-w4-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
