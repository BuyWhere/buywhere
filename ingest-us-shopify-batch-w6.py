...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w6.json"
CANDIDATES_FILE = "data/us_shopify_batch_6.json"
LOG_FILE = f"data/shopify-batch-w6-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
