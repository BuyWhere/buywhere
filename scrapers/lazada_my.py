...
Scrapes electronics, fashion, home & living, beauty, and sports
from Lazada MY and outputs structured JSON matching the BuyWhere catalog schema
for ingestion via POST /v1/ingest/products.

Usage:
    python -m scrapers.lazada_my --api-key <key> [--batch-size 100] [--delay 1.0]
    python -m scrapers.lazada_my --scrape-only

Electronics verticals:
- Mobile phones, laptops, audio, cameras, accessories - target 15K
Fashion verticals:
- Women/men/kids fashion, bags, shoes - target 15K
Home & Living verticals:
- Home appliances, furniture, kitchenware - target 10K
Beauty & Health:
- Beauty, skincare, health - target 10K
...
try:
    ...
    log = get_logger("lazada_my")
except ImportError:
    import logging
    log = logging.getLogger("lazada_my")
...
CATEGORIES = [
    {"id": "phones", "name": "Electronics", "sub": "Phones", "url": "https://www.lazada.com.my/phones/"},
    {"id": "laptops", "name": "Electronics", "sub": "Laptops", "url": "https://www.lazada.com.my/laptops/"},
    {"id": "tvs", "name": "Electronics", "sub": "TVs", "url": "https://www.lazada.com.my/tvs/"},
    {"id": "cameras", "name": "Electronics", "sub": "Cameras", "url": "https://www.lazada.com.my/cameras/"},
    {"id": "audio", "name": "Electronics", "sub": "Audio & Headphones", "url": "https://www.lazada.com.my/audio-headphones/"},
    {"id": "tablets", "name": "Electronics", "sub": "Tablets", "url": "https://www.lazada.com.my/tablets/"},
    {"id": "wearables", "name": "Electronics", "sub": "Wearables", "url": "https://www.lazada.com.my/smart-watches-wearables/"},
    {"id": "women-fashion", "name": "Fashion", "sub": "Women Fashion", "url": "https://www.lazada.com.my/womens-fashion/"},
    {"id": "men-fashion", "name": "Fashion", "sub": "Men Fashion", "url": "https://www.lazada.com.my/mens-fashion/"},
    {"id": "kids-fashion", "name": "Fashion", "sub": "Kids Fashion", "url": "https://www.lazada.com.my/kids-fashion/"},
    {"id": "bags-luggage", "name": "Fashion", "sub": "Bags & Luggage", "url": "https://www.lazada.com.my/bags-luggage/"},
    {"id": "shoes", "name": "Fashion", "sub": "Shoes", "url": "https://www.lazada.com.my/shoes/"},
    {"id": "furniture", "name": "Home & Living", "sub": "Furniture", "url": "https://www.lazada.com.my/furniture/"},
    {"id": "kitchen", "name": "Home & Living", "sub": "Kitchen & Dining", "url": "https://www.lazada.com.my/kitchen-dining/"},
    {"id": "home-appliances", "name": "Home & Living", "sub": "Home Appliances", "url": "https://www.lazada.com.my/home-appliances/"},
    {"id": "beauty", "name": "Beauty & Health", "sub": "Beauty & Makeup", "url": "https://www.lazada.com.my/beauty-makeup/"},
    {"id": "skincare", "name": "Beauty & Health", "sub": "Skincare", "url": "https://www.lazada.com.my/skincare/"},
    {"id": "sports", "name": "Sports & Outdoors", "sub": "Sports Equipment", "url": "https://www.lazada.com.my/sports-fitness/"},
]
...
class LazadaMYScraper:
    def __init__(
        ...
        data_dir: str = "/home/paperclip/buywhere-api/data/lazada-my",
    ...
    def _transform_lazada_product(self, raw: dict, category: dict) -> dict[str, Any] | None:
        try:
            ...
            if isinstance(price, str):
                price = float(price.replace("RM", "").replace(",", "").strip() or 0)
            original_price = raw.get("originalPrice", price)
            if isinstance(original_price, str):
                original_price = float(original_price.replace("RM", "").replace(",", "").strip() or 0)
    ...
    async def run(self) -> dict[str, Any]:
        print(f"Lazada MY Scraper starting...")
...
async def main():
    parser = argparse.ArgumentParser(description="Lazada Malaysia Product Scraper")
    parser.add_argument("--api-key", default=os.environ.get("BUYWHERE_API_KEY", ""), help="BuyWhere API key")
    parser.add_argument("--api-base", default=os.environ.get("BUYWHERE_API_BASE", "http://localhost:8000"), help="BuyWhere API base URL")
    ...
    parser.add_argument("--data-dir", default="/home/paperclip/buywhere-api/data/lazada-my", help="Directory to save scraped JSONL data")
