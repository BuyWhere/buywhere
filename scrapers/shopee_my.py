"""
Shopee Malaysia product scraper.

Scrapes electronics, home appliances, food & beverages, health, beauty, and fashion
from Shopee MY and outputs structured JSON matching the BuyWhere catalog schema
for ingestion via POST /v1/ingest/products.

Uses ScraperAPI in HTTP proxy mode with ultra_premium and session support
to bypass Shopee MY anti-bot protection.

Usage:
    SCRAPERAPI_KEY=... python -m scrapers.shopee_my \\
        --api-key <key> --use-scraperapi-proxy --limit 50000
    ...
    python bulk_ingest.py /tmp/shopee_my_<ts>.jsonl --batch-size 200
...
CATEGORIES = [
    {"id": "electronics-phones", "name": "Electronics", "sub": "Phones", "url": "https://shopee.com.my/Mobile-Cell-Phone-i.6069.6069"},
    {"id": "electronics-laptops", "name": "Electronics", "sub": "Laptops", "url": "https://shopee.com.my/Laptops-i.1852.1852"},
    {"id": "electronics-audio", "name": "Electronics", "sub": "Audio", "url": "https://shopee.com.my/Headphones-Earphones-i.11094.11094"},
    {"id": "electronics-cameras", "name": "Electronics", "sub": "Cameras", "url": "https://shopee.com.my/Cameras-DSLRs-i.814.814"},
    {"id": "electronics-accessories", "name": "Electronics", "sub": "Accessories", "url": "https://shopee.com.my/Mobile-Accessories-i.19766.19766"},
    {"id": "home-kitchen", "name": "Home Appliances", "sub": "Kitchen", "url": "https://shopee.com.my/Kitchen-Appliances-i.7108.7108"},
    {"id": "home-cleaning", "name": "Home Appliances", "sub": "Cleaning", "url": "https://shopee.com.my/Home-Cleaning-Tools-i.19499.19499"},
    {"id": "home-aircon", "name": "Home Appliances", "sub": "Air Conditioners", "url": "https://shopee.com.my/Air-Conditioners-i.6046.6046"},
    {"id": "home-fans", "name": "Home Appliances", "sub": "Fans", "url": "https://shopee.com.my/Fans-i.6051.6051"},
    {"id": "food-groceries", "name": "Food & Beverages", "sub": "Groceries", "url": "https://shopee.com.my/Groceries-i.2266.2266"},
    {"id": "food-snacks", "name": "Food & Beverages", "sub": "Snacks", "url": "https://shopee.com.my/Snacks-i.11087.11087"},
    {"id": "food-drinks", "name": "Food & Beverages", "sub": "Drinks", "url": "https://shopee.com.my/Beverages-i.18530.18530"},
    {"id": "health-supplements", "name": "Health", "sub": "Supplements", "url": "https://shopee.com.my/Health-Supplements-i.22222.22222"},
    {"id": "health-personal", "name": "Health", "sub": "Personal Care", "url": "https://shopee.com.my/Personal-Care-i.22528.22528"},
    {"id": "health-pharmacy", "name": "Health", "sub": "Pharmacy", "url": "https://shopee.com.my/Pharmacy-i.22525.22525"},
    {"id": "beauty-skincare", "name": "Beauty", "sub": "Skincare", "url": "https://shopee.com.my/Skincare-i.22216.22216"},
    {"id": "beauty-makeup", "name": "Beauty", "sub": "Makeup", "url": "https://shopee.com.my/Makeup-i.22204.22204"},
    {"id": "beauty-tools", "name": "Beauty", "sub": "Beauty Tools", "url": "https://shopee.com.my/Beauty-Tools-i.22205.22205"},
]


class ShopeeMYScraper:
    def __init__(
        self,
        api_key: str,
    ...
    def _ensure_output_dir(self):
        ...
        self.products_outfile = os.path.join(OUTPUT_DIR, f"shopee_my_{ts}.jsonl")
    ...
    def transform_product(self, raw: dict, category: dict) -> dict[str, Any] | None:
        try:
            ...
            image_url = ""
            if images:
                image_url = f"https://cf.shopee.com.my/file/{images[0]}"

            product_url = f"https://shopee.com.my/product/{shopid}/{itemid}"
    ...
    async def run(self, limit: int = 0) -> dict[str, Any]:
        ...
        print(f"Shopee MY Scraper starting...")
...
async def main():
    parser = argparse.ArgumentParser(description="Shopee MY Scraper — Malaysia Verticals")
    parser.add_argument("--api-key", default=os.environ.get("BUYWHERE_API_KEY", ""), help="BuyWhere API key")
    parser.add_argument(
        "--api-base",
        default=os.environ.get("BUYWHERE_API_BASE", "http://localhost:8000"),
