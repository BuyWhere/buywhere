...
var SearchProductsTool = class extends Tool {
  constructor(config) {
    super();
...
var ComparePricesTool = class extends Tool {
  constructor(config) {
    super();
...
var GetDealsTool = class extends Tool {
  constructor(config) {
    super();
    this.name = "get_deals";
...
var GetProductDetailsTool = class extends Tool {
  constructor(config) {
    super();
...
var GetPriceHistoryTool = class extends Tool {
  constructor(config) {
    super();
...
var AgentSearchProductsTool = class extends Tool {
  constructor(config) {
    super();
...
var ResolveProductQueryTool = class extends Tool {
  constructor(config) {
    super();
...
var FindBestPriceTool = class extends Tool {
  constructor(config) {
    super();
...
var CompareProductsTool = class extends Tool {
  constructor(config) {
    super();
...
var GetProductDetailsV2Tool = class extends Tool {
  constructor(config) {
    super();
...
var GetPurchaseOptionsTool = class extends Tool {
  constructor(config) {
    super();
