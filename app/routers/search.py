...
async def search_products(
    ...
    if country is not None:
        ...
        # BUY-82928: DO NOT filter by currency. SG catalog has mostly USD products
        # (Shopify Titan). Filtering by SGD returns near-zero results. Show all
        # products for the country regardless of price currency.
    ...
    if offset == 0 and not q:
        ...
        if country is not None:
            ...
            # BUY-82928: DO NOT filter by currency in count
        if region is not None and country is None:
    ...
    if include_facets and offset == 0:
        ...
        if country is not None:
            ...
            # BUY-82928: DO NOT filter by currency in facets
        if region is not None and country is None:
            region_codes = [r.strip().lower() for r in region.split(",")]
