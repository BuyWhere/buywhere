...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w1.json"
CANDIDATES_FILE = "data/us_shopify_batch_1.json"
LOG_FILE = f"data/shopify-batch-w1-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
