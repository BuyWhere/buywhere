...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w7.json"
CANDIDATES_FILE = "data/us_shopify_batch_7.json"
LOG_FILE = f"data/shopify-batch-w7-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
