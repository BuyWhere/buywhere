#!/usr/bin/env bash
# run-buy-57611-worker-wc-cycle-cleanup.sh
# BUY-57611: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/BUY-57611-evidence/apply-report.json"
LOG_PATH="$REPO_ROOT/BUY-57611-evidence/apply-log.jsonl"
DRYRUN_REPORT_PATH="$REPO_ROOT/BUY-57611-evidence/dryrun-report.json"
DRYRUN_LOG_PATH="$REPO_ROOT/BUY-57611-evidence/dryrun-log.jsonl"
EVIDENCE_DIR="$REPO_ROOT/BUY-57611-evidence"
...
log "BUY-57611 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
