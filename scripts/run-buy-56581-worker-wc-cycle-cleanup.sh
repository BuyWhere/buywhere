...
# run-buy-56581-worker-wc-cycle-cleanup.sh
# BUY-56581: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-56581-evidence"
...
log "BUY-56581 enforcement starting"
...
log "BUY-56581 enforcement completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
