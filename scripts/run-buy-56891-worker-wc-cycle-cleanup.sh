...
EVIDENCE_DIR="$PROJECT_ROOT/BUY-56891-evidence"
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56891 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56891 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
