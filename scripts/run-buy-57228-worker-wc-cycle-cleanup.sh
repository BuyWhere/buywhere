...
# run-buy-57228-worker-wc-cycle-cleanup.sh
# BUY-57228: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-57228-evidence"
...
log "=== BUY-57228 Worker node WC cycle artifact cleanup ==="
...
log "=== BUY-57228 completed. exit=$APPLY_EXIT ==="
