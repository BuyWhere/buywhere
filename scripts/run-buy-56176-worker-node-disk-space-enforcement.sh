#!/usr/bin/env bash
# run-buy-56176-worker-node-disk-space-enforcement.sh
# BUY-56176: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-56176-wc-cycle-enforcement-report.json"
...
log "BUY-56176 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
