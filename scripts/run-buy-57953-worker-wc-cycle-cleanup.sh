#!/usr/bin/env bash
# run-buy-57953-worker-wc-cycle-cleanup.sh
# BUY-57953: Worker node WC cycle artifact cleanup enforcement
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-57953-wc-cycle-enforcement-report.json"
...
log "BUY-57953 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
