...
# BUY-56274: Worker node WC cycle artifact cleanup
...
REPORT_PATH="$PROJECT_ROOT/logs/buy-56274-wc-cycle-cleanup-report.json"

mkdir -p "$(dirname "$REPORT_PATH")"

echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56274 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56274 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
