#!/usr/bin/env bash
# run-buy-57631-worker-disk-enforcement.sh
# BUY-57631: Worker node disk-space enforcement
#
...
mkdir -p "$REPO_ROOT/BUY-57631-evidence"
LOG_FILE="$REPO_ROOT/logs/buy-57631-disk-enforcement.log"
REPORT_PATH="$REPO_ROOT/BUY-57631-evidence/enforcement-report.json"
...
main() {
  ...
  log "BUY-57631 disk enforcement check: disk=${disk_pct}% free=${disk_free}GB threshold=${ALERT_PCT}%"
