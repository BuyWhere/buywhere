#!/usr/bin/env bash
# run-buy-57667-worker-wc-cycle-cleanup.sh
# BUY-57667: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/BUY-57667-evidence/apply-report.json"
LOG_PATH="$REPO_ROOT/BUY-57667-evidence/apply-log.jsonl"
DRYRUN_REPORT_PATH="$REPO_ROOT/BUY-57667-evidence/dryrun-report.json"
DRYRUN_LOG_PATH="$REPO_ROOT/BUY-57667-evidence/dryrun-log.jsonl"
EVIDENCE_DIR="$REPO_ROOT/BUY-57667-evidence"
...
log "BUY-57667 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
