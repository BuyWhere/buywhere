#!/usr/bin/env bash
# run-buy-56179-worker-node-disk-space-enforcement.sh
# BUY-56179: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-56179-wc-cycle-enforcement-report.json"
...
log "BUY-56179 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
