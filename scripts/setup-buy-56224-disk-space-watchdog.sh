#!/usr/bin/env bash
# setup-buy-56224-disk-space-watchdog.sh — BUY-56224 / BUY-48198
...
RUNNER="$SCRIPT_DIR/run-buy-56224-disk-space-watchdog-cron.sh"
LOG_FILE="$REPO_ROOT/logs/buy-56224-disk-space-watchdog.log"
MARKER="buy-56224-disk-space-watchdog-cron"

CRON_JOB="*/5 * * * * . /home/paperclip/.paperclip_env; cd $REPO_ROOT && bash $RUNNER >> $LOG_FILE 2>&1 # BUY-56224/BUY-48198: Disk space watchdog — every 5 min"
