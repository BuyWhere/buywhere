...
# BUY-57053: Worker node disk-space enforcement (WC cycle artifact cleanup)
...
EVIDENCE_DIR="$PROJECT_ROOT/BUY-57053-evidence"
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-57053 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-57053 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
