#!/usr/bin/env bash
# buy-57732-disk-cleanup.sh — Workspace safe-data-cleanup sweep
...
LOG_FILE="$REPO_ROOT/logs/buy-57732-disk-cleanup.log"
...
echo "[$TS] Evidence cleanup: deleted $DELETED_COUNT dirs (~${DELETED_MB}MB). Disk: ${disk_before_gb}GB -> ${disk_after_gb}GB free" >> "$REPO_ROOT/logs/buy-57732-disk-enforcement.log"
