...
# run-buy-56609-worker-wc-cycle-cleanup.sh
# run-buy-56605-worker-wc-cycle-cleanup.sh
# BUY-56609: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-56609-evidence"
...
log "BUY-56609 enforcement starting"
...
log "BUY-56609 enforcement completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
