...
EVIDENCE_DIR="$REPO_ROOT/BUY-57647-evidence"
...
log "BUY-57647: WC cycle artifact cleanup starting"
...
log "BUY-57647: cleanup completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
