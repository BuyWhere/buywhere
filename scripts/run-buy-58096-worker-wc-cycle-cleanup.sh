#!/usr/bin/env bash
# run-buy-58096-worker-wc-cycle-cleanup.sh
# BUY-58096: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
# Runs wc-cycle-cleanup.sh --apply --keep=48 in buywhere-api workspace to delete
...
REPORT_PATH="$REPO_ROOT/logs/buy-58096-wc-cycle-enforcement-report.json"
...
log "BUY-58096 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
