#!/usr/bin/env bash
# run-buy-57675-worker-wc-cycle-cleanup.sh
# BUY-57675: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/BUY-57675-evidence/apply-report.json"
LOG_PATH="$REPO_ROOT/BUY-57675-evidence/apply-log.jsonl"
DRYRUN_REPORT_PATH="$REPO_ROOT/BUY-57675-evidence/dryrun-report.json"
DRYRUN_LOG_PATH="$REPO_ROOT/BUY-57675-evidence/dryrun-log.jsonl"
EVIDENCE_DIR="$REPO_ROOT/BUY-57675-evidence"
...
log "BUY-57675 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
