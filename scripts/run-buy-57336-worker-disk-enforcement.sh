...
EVIDENCE_DIR="$REPO_ROOT/BUY-57336-evidence"
...
log "BUY-57336 cron wrapper starting"
echo_it "BUY-57336: worker node disk-space enforcement starting"
...
echo_it "BUY-57336: enforcement ${STATUS_TEXT} disk=${DISK_PCT}% free=${DISK_FREE_GB}GB"
echo_it "Evidence: $EVIDENCE_REPORT"
log "BUY-57336 cron wrapper complete exit=$ENFORCER_EXIT disk=${DISK_PCT}% free=${DISK_FREE_GB}GB"
