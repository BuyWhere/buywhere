...
# run-buy-56670-worker-wc-cycle-cleanup.sh
# BUY-56670: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-56670-evidence"
...
log "BUY-56670 enforcement starting"
...
log "BUY-56670 enforcement completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
