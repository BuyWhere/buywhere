#!/usr/bin/env bash
# run-buy-56228-worker-node-disk-space-enforcement.sh
# BUY-56228: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
# Runs wc-cycle-cleanup.sh --apply --keep=48 in the Oracle (buy30331) workspace to
...
# Oracle workspace — the high-ingestion node that accumulates cycle artifacts
WORKSPACE_DIR="/paperclip/instances/default/workspaces/3ec8f6dd-1735-4479-9825-a2c42edac34c"
REPORT_PATH="$REPO_ROOT/logs/buy-56228-wc-cycle-enforcement-report.json"
...
log "BUY-56228 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
