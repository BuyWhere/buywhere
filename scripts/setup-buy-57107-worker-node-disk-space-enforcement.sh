...
# setup-buy-57107-worker-node-disk-space-enforcement.sh
...
RUNNER="$REPO_ROOT/scripts/run-buy-57107-worker-wc-cycle-cleanup.sh"
LOG_FILE="$REPO_ROOT/logs/buy-57107-disk-space-enforcement-cron.log"
CRON_MARKER="# BUY-57107: Worker node disk-space enforcement (WC cycle cleanup, Oracle scrape-data workspace) -- hourly"
...
echo "Installed hourly cron entry for BUY-57107."
