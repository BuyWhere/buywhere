#!/usr/bin/env bash
# run-buy-57654-worker-disk-enforcement.sh
# BUY-57654: Worker node disk-space enforcement runner
#
# Invokes worker-node-disk-enforcement.sh with BUY-57654 configuration.
set -euo pipefail
...
log() { echo "[$(date -u +"%Y-%m-%dT%H:%M:%SZ")] BUY-57654: $*"; }
