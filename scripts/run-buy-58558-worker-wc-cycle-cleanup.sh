#!/usr/bin/env bash
# run-buy-58558-worker-wc-cycle-cleanup.sh
# BUY-58558: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-58558-wc-cycle-enforcement-report.json"
LOG_PATH="${LOG_PATH:-$WORKSPACES_ROOT/logs/buy58558_wc_cycle_cleanup_log.jsonl}"
...
log "BUY-58558 enforcement starting"
...
log "BUY-58558 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
