#!/usr/bin/env bash
# setup-buy-56447-disk-space-watchdog.sh — BUY-56447 / BUY-48198
...
RUNNER="$SCRIPT_DIR/run-buy-56447-disk-space-watchdog-cron.sh"
LOG_FILE="$REPO_ROOT/logs/buy-56447-disk-space-watchdog.log"
MARKER="BUY-56447: Disk space watchdog"
...
echo "Disk space watchdog cron installed for BUY-56447/BUY-48198. Runner: $RUNNER"
bash "$RUNNER"
