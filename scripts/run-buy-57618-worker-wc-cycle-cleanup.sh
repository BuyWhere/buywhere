#!/usr/bin/env bash
# run-buy-57618-worker-wc-cycle-cleanup.sh
# BUY-57618: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-57618-wc-cycle-enforcement-report.json"
LOG_PATH="$REPO_ROOT/logs/buy-57618-wc-cycle-cleanup-log.jsonl"
...
log "BUY-57618 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
