#!/usr/bin/env bash
# run-buy-56285-worker-node-disk-space-enforcement.sh
...
REPORT_PATH="$REPO_ROOT/logs/buy-56285-wc-cycle-enforcement-report.json"
...
log "BUY-56285 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
