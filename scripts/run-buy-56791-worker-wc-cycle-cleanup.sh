...
# BUY-56791: Worker node disk-space enforcement (WC cycle artifact cleanup)
...
EVIDENCE_DIR="$PROJECT_ROOT/BUY-56791-evidence"
...
DISK_REPORT="$EVIDENCE_DIR/disk-report.json"

mkdir -p "$EVIDENCE_DIR"

echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56791 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56791 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
