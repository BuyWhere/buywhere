#!/usr/bin/env bash
# run-buy-56493-worker-node-disk-space-enforcement.sh
# BUY-56493: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-56493-wc-cycle-enforcement-report.json"
LOG_PATH="$WORKSPACES_ROOT/logs/buy-56493-wc-cycle-enforcement-log.jsonl"
...
log "BUY-56493 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
