#!/usr/bin/env bash
# run-buy-57925-worker-wc-cycle-cleanup.sh
# BUY-57925: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-57925-wc-cycle-enforcement-report.json"
...
log "BUY-57925 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
