...
# run-buy-56509-worker-wc-cycle-cleanup.sh
# BUY-56509: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-56509-wc-cycle-enforcement-report.json"
LOG_PATH="$WORKSPACES_ROOT/logs/buy-56509-wc-cycle-enforcement-log.jsonl"
...
log "BUY-56509 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
