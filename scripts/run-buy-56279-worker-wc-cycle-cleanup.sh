...
# BUY-56279: Worker node WC cycle artifact cleanup
...
REPORT_PATH="$PROJECT_ROOT/logs/buy-56279-wc-cycle-cleanup-report.json"

mkdir -p "$(dirname "$REPORT_PATH")"

echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56279 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56279 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
