#!/usr/bin/env bash
# run-buy-57639-worker-wc-cycle-cleanup.sh
# BUY-57639: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-57639-evidence"
...
log "BUY-57639: WC cycle artifact cleanup starting"
...
log "BUY-57639: cleanup completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
