...
# run-buy-56551-worker-wc-cycle-cleanup.sh
# BUY-56551: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-56551-evidence"
...
log "BUY-56551 enforcement starting"
...
log "BUY-56551 enforcement completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
