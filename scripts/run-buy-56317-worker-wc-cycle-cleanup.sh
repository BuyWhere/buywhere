...
# BUY-56317: Worker node disk-space enforcement (WC cycle artifact cleanup)
...
LOG_PATH="$PROJECT_ROOT/logs/buy-56317-wc-cycle-cleanup-log.jsonl"
REPORT_PATH="$PROJECT_ROOT/logs/buy-56317-wc-cycle-cleanup-report.json"

echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56317 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56317 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
