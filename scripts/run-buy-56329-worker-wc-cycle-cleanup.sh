...
EVIDENCE_DIR="$PROJECT_ROOT/BUY-56329-evidence"
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56329 Worker node WC cycle artifact cleanup starting"
echo "=========================================="
...
echo "=========================================="
echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] BUY-56329 cleanup completed. exit=$EXIT_CODE"
echo "=========================================="
