#!/usr/bin/env bash
# run-buy-57449-worker-wc-cycle-cleanup.sh
# BUY-57449: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-57449-wc-cycle-enforcement-report.json"
...
log "BUY-57449 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
