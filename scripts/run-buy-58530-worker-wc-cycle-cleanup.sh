#!/usr/bin/env bash
# run-buy-58530-worker-wc-cycle-cleanup.sh
# BUY-58530: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-58530-wc-cycle-enforcement-report.json"
...
log "BUY-58530 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
