#!/usr/bin/env bash
# run-buy-57645-worker-wc-cycle-cleanup.sh
# BUY-57645: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
EVIDENCE_DIR="$REPO_ROOT/BUY-57645-evidence"
...
log "BUY-57645: WC cycle artifact cleanup starting"
...
log "BUY-57645: cleanup completed. inner_exit=$inner_exit disk_before=${disk_pct_before}% disk_after=${disk_pct_after}%"
exit $inner_exit
