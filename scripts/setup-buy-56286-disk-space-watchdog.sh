#!/usr/bin/env bash
# setup-buy-56286-disk-space-watchdog.sh — BUY-56286 / BUY-48198
...
RUNNER="$SCRIPT_DIR/run-buy-56286-disk-space-watchdog-cron.sh"
LOG_FILE="$REPO_ROOT/logs/buy-56286-disk-space-watchdog.log"
MARKER="BUY-56286: Disk space watchdog"
...
echo "Disk space watchdog cron installed for BUY-56286/BUY-48198. Runner: $RUNNER"
bash "$RUNNER"
