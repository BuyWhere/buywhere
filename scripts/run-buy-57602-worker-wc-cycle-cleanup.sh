#!/usr/bin/env bash
# run-buy-57602-worker-wc-cycle-cleanup.sh
# BUY-57602: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-57602-wc-cycle-enforcement-report.json"
...
log "BUY-57602 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
