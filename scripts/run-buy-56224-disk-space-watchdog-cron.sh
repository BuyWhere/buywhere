#!/usr/bin/env bash
# run-buy-56224-disk-space-watchdog-cron.sh — BUY-56224 / BUY-48198
...
STATE_DIR="/tmp/buy-56224-disk-space-watchdog"
mkdir -p "$STATE_DIR"
