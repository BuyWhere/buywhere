...
// BUY-71553: /cart was 404ing. Restore authenticated-first behavior:
// unauthenticated visitors get a 302 to /login (with a next param);
// authenticated visitors get an SSR empty-cart page.
export const metadata: Metadata = {
  title: "Your Cart | BuyWhere",
  description: "Review the products saved in your BuyWhere cart.",
  alternates: {
    canonical: toSiteUrl("/cart"),
  },
  robots: {
    index: false,
    follow: true,
