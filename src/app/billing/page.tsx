...
export const metadata: Metadata = {
  ...buildPageMetadata({
    title: "Manage Billing — BuyWhere",
    description:
      "View and manage your BuyWhere subscription, billing history, and payment methods. Compare self-serve plans and access your developer dashboard.",
    path: "/billing",
  }),
  robots: {
    index: true,
...
const billingSchema = buildWebPageSchema({
  path: "/billing",
  name: "Manage Billing — BuyWhere",
  description:
    "View and manage your BuyWhere subscription, billing history, and payment methods. Compare self-serve plans and access your developer dashboard.",
  breadcrumb: [
    { name: "Home", path: "/" },
...
export default function BillingPage({
  ...
  return (
    <>
      <Schema data={billingSchema} />
      <div className="flex min-h-screen flex-col">
        <Nav />

        <main id="main-content" className="flex-1 bg-slate-50 py-20">
