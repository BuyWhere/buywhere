...
const audiences = [
  {
    ...
    desc: "One API, one schema, 381M+ products. Pass deliver_to with your user's country and get deliverable-first results with availability labels — local, ships_to_you, or unavailable — on every product.",
    cta: "Read the docs",
    ctaHref: "/developers",
  },
  {
...
const webApplicationSchema = {
  ...
  name: "BuyWhere API",
  description:
    "Product catalog API and MCP server for AI agents. 381M+ products from 900,000+ merchants worldwide — normalized, deduplicated, location-aware. deliver_to ranking, availability labels, sub-250ms search.",
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "BuyWhere",
      description:
        "MCP server and product catalog API for AI agents. 381M+ products from 900,000+ merchants worldwide, with location-aware deliver_to ranking and availability labels.",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-20 md:pt-20 md:pb-24 xl:pt-24 xl:pb-28">
          <div className="max-w-3xl mx-auto text-center mb-6">
            <div className="hero-badge mx-auto inline-flex max-w-[18rem] flex-row flex-wrap items-center justify-center gap-x-2 gap-y-1 rounded-2xl border border-white bg-white px-4 py-2 text-center text-xs font-bold text-indigo-900 shadow-sm sm:max-w-none sm:flex-nowrap sm:items-center sm:gap-x-2 sm:rounded-full sm:px-3 sm:py-1 sm:text-left sm:text-sm">
              <span className="inline-flex shrink-0 items-center gap-x-1.5">
                ...
                <span className="whitespace-nowrap">381M+ products</span>
              </span>
          ...
          <div className="max-w-3xl mx-auto text-center mt-8">
            ...
            <p className="text-base font-semibold text-white">
              381M+ structured products from 900,000+ merchant catalogs — normalized, deduplicated, and location-aware.
            </p>
          </div>
        </div>
      </section>
