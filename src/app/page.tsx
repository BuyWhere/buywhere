...
const audiences = [
  {
    ...
    desc: "One API, one schema, 370M+ products across 900,000+ merchants. Pass deliver_to with your user's country and get deliverable-first results with availability labels — local, ships_to_you, or unavailable — on every product.",
    cta: "Read the docs",
    ctaHref: "/developers",
  },
  {
...
const webApplicationSchema = {
  ...
  name: "BuyWhere API",
  description:
    "Product catalog API and MCP server for AI agents. 370M+ products across 900,000+ merchants worldwide — normalized, deduplicated, location-aware. deliver_to ranking, availability labels, sub-250ms search.",
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "BuyWhere",
      description:
        "MCP server and product catalog API for AI agents. 370M+ products across 900,000+ merchants worldwide, with location-aware deliver_to ranking and availability labels.",
    ...
    <>
      ...
      <section role="region" aria-label="Content section" className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 text-white pb-safe">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-20 md:pt-20 md:pb-24 xl:pt-24 xl:pb-28">
          ...
          <HomeProductSearch />
          <div className="max-w-3xl mx-auto text-center mt-8 pb-8 sm:pb-8 md:pb-10">
            <p className="text-base font-semibold text-white leading-snug px-4 pb-safe">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                <h3 className="font-semibold text-gray-900 mb-1 leading-snug line-clamp-2">{title}</h3>
