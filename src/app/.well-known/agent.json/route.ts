const AGENT_JSON = {
  name: 'BuyWhere',
  description:
    'Agent-native product catalog API for AI shopping agents: 370M+ products from 900,000+ merchants worldwide, with location-aware deliver_to ranking and per-result availability labels.',
