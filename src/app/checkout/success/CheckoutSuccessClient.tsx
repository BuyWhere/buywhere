...
// Renders ONLY the dynamic post-checkout subscription read-back.
// The static confirmation H1 / badge / intro / CTAs live in the server
// page.tsx so they are present in SSR. This client island reads the API key
// from localStorage and fetches the live subscription, so it is wrapped in
// <Suspense> by the parent.
