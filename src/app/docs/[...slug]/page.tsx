...
export default function DocPage({ params }: DocRouteParams) {
  ...
  // BUY-69733: per-doc JSON-LD so docs pages carry the same structured data
  // (WebPage + BreadcrumbList, linked to the site-wide Organization/WebSite
  // entities) as the rest of the site instead of serving bare HTML.
