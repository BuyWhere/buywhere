      ...
      <section className="py-16 bg-gray-50 border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            Instead of checking each store individually, use BuyWhere to search across 950,000+ retailers at once. Our catalog normalizes prices, availability, and product data so you get apples-to-apples comparisons.
          </p>
          <Link
            href="/search"
