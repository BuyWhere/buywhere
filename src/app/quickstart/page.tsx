        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="rounded-[2rem] border border-indigo-100 bg-indigo-50 p-8 shadow-sm">
            ...
            <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
              Skip the human form when you are provisioning an agent. This call returns an <code className="rounded bg-white px-1.5 py-0.5 text-sm text-slate-900">api_key</code> instantly on the free tier (10 requests/minute, 10,000 requests/day).
            </p>
            <div className="mt-6">
