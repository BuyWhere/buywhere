...
export const metadata = {
  title: "BuyWhere — AI-Powered Product Discovery in the United States",
  description:
    "Search, compare, and discover products across thousands of US stores with BuyWhere's MCP server and product catalog API.",
  alternates: {
    canonical: "/products/us",
  },
};

export default function ProductsUsIndexPage() {
  const schema = buildWebPageSchema({
    ...
    breadcrumb: [
      ...
      { name: "United States", path: "/products/us" },
    ],
  });
  return (
    <>
