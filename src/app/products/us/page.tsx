...
export const metadata: Metadata = {
  title: "US Products — Compare Prices Across Amazon, Walmart & More | BuyWhere",
  description:
    "Search, compare, and discover products across thousands of US stores. Compare prices on Amazon, Walmart, and Target with BuyWhere.",
  alternates: { canonical: toSiteUrl("/products/us") },
  openGraph: {
    title: "US Products — Compare Prices | BuyWhere",
    description:
      "Search, compare, and discover products across Amazon, Walmart, and Target.",
    url: toSiteUrl("/products/us"),
    type: "website",
    siteName: "BuyWhere",
    locale: "en_US",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "BuyWhere — Compare US Product Prices" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "US Products — Compare Prices | BuyWhere",
    description:
      "Compare prices across Amazon, Walmart, and Target.",
  },
  robots: { index: true, follow: true },
};

export default function ProductsUsLandingPage() {
  const schema = buildWebPageSchema({
    path: "/products/us",
    name: "BuyWhere — Compare Prices Across US Stores",
    description:
      "Search, compare, and discover products across Amazon, Walmart, and Target with BuyWhere's price comparison engine.",
    inLanguage: "en-US",
    breadcrumb: [
      { name: "Home", path: "/" },
      { name: "US Products", path: "/products/us" },
    ],
  });
  return (
    <>
        ...
        <section className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 text-white py-20 md:py-24">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
            <nav className="text-sm text-indigo-200 mb-6" aria-label="Breadcrumb">
              ...
              <span className="text-white">US Products</span>
            </nav>
            ...
            <p className="mt-6 text-lg md:text-xl text-indigo-100 max-w-2xl mx-auto">
              Search, compare, and discover products across America&apos;s top retailers — all in one place.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-center mb-12">
              How BuyWhere helps you shop smarter in the US
            </h2>
