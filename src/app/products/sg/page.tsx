...
export const metadata = {
  title: "BuyWhere — AI-Powered Product Discovery in Singapore",
  description:
    "Search, compare, and discover products across Shopee, Lazada, and other Singapore stores with BuyWhere's product catalog.",
  alternates: {
    canonical: "/products/sg",
  },
};

export default function ProductsSgIndexPage() {
  const schema = buildWebPageSchema({
    path: "/products/sg",
    name: "BuyWhere — AI-Powered Product Discovery in Singapore",
    description:
      "Search, compare, and discover products across Shopee, Lazada, and other Singapore stores with BuyWhere's product catalog.",
    breadcrumb: [
      { name: "Home", path: "/" },
      { name: "Products", path: "/products" },
      { name: "Singapore", path: "/products/sg" },
    ],
  });
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center max-w-3xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" style={{ lineHeight: 1.1 }}>
            Find any product. Compare prices across Shopee, Lazada, and more.
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Search, compare, and discover products across Singapore&apos;s top stores — Shopee, Lazada, and more — with BuyWhere&apos;s product catalog.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Enter a product name and instantly see prices from Shopee, Lazada, and other Singapore retailers.</p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 bg-indigo-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
