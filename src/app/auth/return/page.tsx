...
export const metadata: Metadata = {
  title: "Authentication Return — BuyWhere",
  description: "Authentication return page for BuyWhere developer login flow.",
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              Returning from authentication provider. If you are not redirected automatically, please continue.
            </p>
