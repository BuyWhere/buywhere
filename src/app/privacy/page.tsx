...
const PRIVACY_TITLE = "Privacy Policy — BuyWhere";
const PRIVACY_DESCRIPTION = "BuyWhere Privacy Policy";
const PRIVACY_CANONICAL_URL = toSiteUrl("/privacy");
