...
export const PRODUCT_TAXONOMY: TaxonomyCategory[] = [
  ...
  },
  {
    ...
    description: 'Compare prices on books, notebooks, and office stationery',
    icon: '📚',
    regions: ['us', 'sg', 'sea'],
  },
  {
    ...
    name: 'Health & Beauty',
    slug: 'health-beauty',
    description: 'Compare prices on health, skincare, and beauty products',
    icon: '✨',
    regions: ['us', 'sg', 'sea'],
  },
  {
    ...
    name: 'Home & Kitchen',
    slug: 'home-kitchen',
    description: 'Compare prices on kitchenware, appliances, and home essentials',
    icon: '🍳',
    regions: ['us', 'sg', 'sea'],
  },
  {
    ...
    name: 'Beauty & Health',
    slug: 'beauty-health',
    description: 'Compare prices on beauty and personal-care products',
    icon: '🧴',
    regions: ['us', 'sg', 'sea'],
  },
  {
    ...
    name: 'Grocery',
    slug: 'grocery',
    description: 'Compare prices on grocery staples and household food items',
    icon: '🛒',
    regions: ['sg', 'sea'],
  },
];
