...
const STATIC_SITEMAP_ROUTES = [
  ...
  // BUY-68977: country landing pages
  { path: "/uk", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/gb", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/ca", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/au", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/de", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/fr", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/in", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/eu", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/ae", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/nz", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/jp", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/kr", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/br", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/mx", priority: 0.8, changeFrequency: "weekly" as const },
  { path: "/za", priority: 0.8, changeFrequency: "weekly" as const },
