        ...
        <div className="min-h-5" aria-live="polite">
          {error ? (
            ...
            <div className="flex flex-col items-start gap-2 text-sm text-white sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-x-3 sm:gap-y-2">
              <span className="inline-flex items-center self-center rounded-full border border-white/30 bg-white/10 px-2.5 py-0.5 font-semibold text-white shadow-sm">Try</span>
