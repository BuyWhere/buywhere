    ...
    <div className="max-w-3xl mx-auto mb-10">
      ...
      >
        <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_180px_auto]">
          ...
          <button
            type="submit"
            className="inline-flex h-[66px] items-center justify-center rounded-xl bg-white px-6 text-base font-semibold text-indigo-700 transition-colors hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-700 sm:col-start-3 sm:row-start-1"
          >
            Search catalog
          </button>
        </div>
