        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-stretch md:gap-3">
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="search-input w-full rounded-xl border-2 border-white/50 bg-indigo-950/60 py-5 pl-14 pr-4 text-lg text-white placeholder-[#F5F7FF] transition-all focus:border-white focus:bg-indigo-950/70 focus:outline-none focus:ring-4 focus:ring-white/20"
          ...
          <select
            ...
            className="h-[66px] w-full shrink-0 rounded-xl border-2 border-white/50 bg-white/10 px-4 text-base font-medium text-white transition-all focus:border-white focus:bg-white/20 focus:outline-none focus:ring-4 focus:ring-white/20 md:w-36"
