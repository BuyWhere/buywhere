        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-stretch lg:gap-3">
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="search-input w-full rounded-xl border-2 border-white/50 bg-indigo-950/60 py-5 pl-14 pr-4 text-lg text-white placeholder-white transition-all focus:border-white focus:bg-indigo-950/70 focus:outline-none focus:ring-4 focus:ring-white/20"
