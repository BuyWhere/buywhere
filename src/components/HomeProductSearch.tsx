        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-stretch md:gap-3">
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border-2 border-white/20 bg-white/10 py-5 pl-14 pr-4 text-lg text-white placeholder-white/85 transition-all focus:border-white focus:bg-white/20 focus:outline-none focus:ring-4 focus:ring-white/20"
