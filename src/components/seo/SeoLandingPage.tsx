  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-slate-900">
      ...
      <main id="main-content" className="flex-1">
        <section className="bg-[linear-gradient(135deg,#0f172a_0%,#1d4ed8_55%,#f59e0b_130%)] text-white">
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 pb-12 sm:gap-12 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:py-24">
            <div>
