  ...
  return (
    ...
    >
      ...
      */}
      ...
      >
        <div
          className={`relative isolate overflow-hidden bg-slate-100 aspect-[4/3] min-w-0 max-w-full rounded-t-[27px] max-sm:max-h-[200px] max-sm:aspect-video max-sm:object-contain`}
