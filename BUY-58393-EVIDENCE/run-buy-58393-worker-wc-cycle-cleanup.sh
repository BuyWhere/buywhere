#!/usr/bin/env bash
# run-buy-58393-worker-wc-cycle-cleanup.sh
# BUY-58393: Worker node disk-space enforcement (WC cycle artifact cleanup)
#
...
REPORT_PATH="$REPO_ROOT/logs/buy-58393-wc-cycle-enforcement-report.json"
...
log "BUY-58393 enforcement completed. inner_exit=$inner_exit"
exit $inner_exit
