...
// GET /.well-known/api-catalog — AI agent catalog discovery endpoint (BUY-10100)
router.get('/api-catalog', (_req, res) => {
    res.json({
        api: 'BuyWhere Product Catalog API',
        version: 'v1',
        description: 'Agent-native product catalog API for AI agent commerce. Indexes 1.5M+ products from 20+ retailers across Southeast Asia and US.',
        ...
        status: {
            ...
            dbHealth: 'https://api.buywhere.ai/health/db',
        },
    });
});
