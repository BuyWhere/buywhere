...
router.get('/v1/admin/metrics/truth', async (_req: Request, res: Response) => {
  try {
    ...
    const ingestionSummary = await db.query(`
    ...
    const merchantPools = await db.query(`
    ...
    const keepaRuns = await db.query(`
    ...
    const embedStats = await db.query(`
