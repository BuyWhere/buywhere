...
// BUY-80159 — /v1/admin/metrics/truth lives in metricsTruth.ts (mounted after
// this router). Do NOT re-register /truth here: Express dispatches the first
// match, and the legacy handler queried dropped columns (products_created,
// completed_at, merchants.pool/created_at, product_embeddings.created_at).
//
// In-memory histogram only for /metrics and /metrics/window.
