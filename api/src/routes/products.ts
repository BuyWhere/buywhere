...
const SG_SEARCH_FRESHNESS_GUARDRAIL_CACHE_VERSION = 'tier-child-fts-v29-b75921v4'; // v29: BUY-75921 v4 title normalization (cached bodies hold raw stuffed titles)
