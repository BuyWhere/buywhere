...
// BUY-56185/BUY-67598: Detect statement_timeout poisoned connections.
...
// NOTE: client.state tracks socket state, NOT transaction-level errors —
// we must check client.transactionStatus (pg PQTRANS_* codes).
