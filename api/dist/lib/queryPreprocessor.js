...
function extractPriceConstraint(q, result) {
    const maxPatterns = [
...
function extractPriceRange(q, result) {
    const rangePatterns = [
...
function extractCountry(q, result) {
...
function extractCategory(q, result) {
