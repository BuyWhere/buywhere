...
exports.identifierMatchPredicate = identifierMatchPredicate;
exports.identifierForcesKeywordMode = identifierForcesKeywordMode;
 ...
 */
function identifierMatchPredicate(id, paramIdx) {
    switch (id.kind) {
        case 'gtin14':
        case 'ean13':
        case 'ean8':
 ...
 */
function identifierForcesKeywordMode(id) {
