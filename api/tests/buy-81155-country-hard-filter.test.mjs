...
const sources = [
  readFileSync(join(__dirname, '../src/routes/products.ts'), 'utf8'),
];

describe('BUY-81155: US search must not leak foreign merchants', () => {
  for (const [i, productsSource] of sources.entries()) {
    it(`hard-filters country_code and excludes PH/IN storefronts (source ${i})`, () => {
