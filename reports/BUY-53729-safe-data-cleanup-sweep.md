# BUY-53729 safe-data-cleanup sweep

Timestamp: 2026-06-19T17:53:45Z
Date: 2026-06-19
...
- Ran `timeout 180s ./safe-data-cleanup.sh --dry-run --skip-r2 --skip-catalog-check --grace=0` in all 13 candidate workspaces and captured issue-local logs under `reports/BUY-53729-*-dryrun.log`.
...
- `/dev/vda1` ended the sweep below the preferred `25 GB` safety margin but above the `20 GB` incident threshold: `24G` free (`24,494,652` 1K blocks available).
...
/dev/vda1      202051056 177540020  24494652  88% /
```
...
- Parent issue [BUY-33215] should receive the current free-space reading after this sweep: `24,494,652` 1K blocks available on `/dev/vda1`.
