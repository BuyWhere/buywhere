# BUY-53304 safe-data-cleanup sweep

Timestamp: 2026-06-19T02:46:08Z to 2026-06-19T02:49:37Z
...
- `/dev/vda1` stayed below the preferred `25 GB` safety margin but above incident territory at the end of the sweep: `24G` free (`24,663,496` 1K blocks available).
...
/dev/vda1      202051056 177371176  24663496  88% /
```
...
5bc984ee-e2d2-4312-9e6c-b2864524a21f  standard   status=0    --- files=200 freed=0.29GB catalogChecked=0 lowMatchKept=0 r2Missed=3 apply=0
...
- Several standard cleanup scripts still return exit code `1` while emitting a normal summary footer. This sweep treated the parseable footer as the source of truth, consistent with the earlier routine reports in this workspace.
...
- Parent issue [BUY-33215] should receive the current free-space reading after this sweep: `24,663,496` 1K blocks available on `/dev/vda1`.
