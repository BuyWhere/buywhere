# BUY-53453 worker node disk-space enforcement (WC cycle artifact cleanup)
...
```bash
REPORT_PATH="$PWD/reports/BUY-53453-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json" \
APPLY=1 \
bash scripts/buy-53114-worker-node-artifact-cleanup.sh \
  2>&1 | tee "$PWD/reports/BUY-53453-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.log"
```
...
- Free space recorded in the cleanup report: `38803488 KB`
- Alert threshold: `90%`
- Alert required: `no`
...
- Markdown report: `reports/BUY-53453-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.md`
- JSON report: `reports/BUY-53453-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json`
- Execution log: `reports/BUY-53453-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.log`
