# BUY-53591 / BUY-48198 Disk Space Watchdog (5min) Verification
...
4. Live cron-wrapper smoke run
   - Command:
     `DISK_STATE_FILE=$PWD/data/buy-53591-disk-state.json DISK_SNAPSHOT_DIR=$PWD/data/buy-53591-disk-monitor-2026-06-19T133125Z DISK_EXECUTION_ISSUE=BUY-53591 LOG_FILE=$PWD/logs/buy-53591_disk_watchdog_cron.log bash scripts/run-buy-48198-disk-watchdog-cron.sh`
   - Result: `rc=0`

## Runtime evidence

- Scheduled cron log: `logs/buy48198_disk_watchdog_cron.log`
  - observed scheduled success at `2026-06-19T13:30:01Z`
- Smoke log: `logs/buy-53591_disk_watchdog_cron.log`
  - `2026-06-19T13:31:25Z` start
  - `2026-06-19T13:31:25Z` complete `rc=0`
- Snapshot: `data/buy-53591-disk-monitor-2026-06-19T133125Z`
- Summary: `data/buy-53591-disk-monitor-2026-06-19T133125Z/summary.md`
- State file: `data/buy-53591-disk-state.json`
- Watchdog verdict: `PASS`
- Filesystem: `/dev/vda1`
- Mount path: `/`
- Free space: `32.5 GB` (`34851438592` bytes)
- Usage: `84%`
- Warning threshold: `20 GB`
- Critical threshold: `5 GB`
- Incident creation: none

The BUY-48198 5-minute disk watchdog remains installed, runs on schedule, and passes a fresh smoke check in this workspace, so BUY-53591 can be closed.
