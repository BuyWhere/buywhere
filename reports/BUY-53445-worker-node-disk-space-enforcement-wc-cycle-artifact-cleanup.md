# BUY-53445 worker node disk-space enforcement (WC cycle artifact cleanup)
...
```bash
REPORT_PATH="$PWD/reports/BUY-53445-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json" \
LOG_PATH="$PWD/reports/BUY-53445-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.log.jsonl" \
...
- Free space after the cleanup report: `38002232 KB`
- Alert threshold: `90%`
- Alert required: `no`
...
- Markdown report: `reports/BUY-53445-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.md`
- JSON report: `reports/BUY-53445-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json`
