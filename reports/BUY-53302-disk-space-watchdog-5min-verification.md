# BUY-53302 / BUY-48198 Disk Space Watchdog (5min) Verification
...
3. Latest observed scheduled wrapper completion from `logs/buy52997_disk_watchdog_cron.log`:
   - Start: `2026-06-19T02:35:01Z`
   - Completion: `2026-06-19T02:35:15Z`
   - Result: `BUY-52997 watchdog complete rc=0`
   - Scheduled watchdog snapshot: `data/buy-48198-disk-monitor-2026-06-19T023515Z`

4. Direct watchdog smoke run for this heartbeat passed:
   - Command: `DISK_STATE_FILE="$PWD/data/buy-53302-disk-state.json" DISK_SNAPSHOT_DIR="$PWD/data/buy-53302-disk-monitor-20260619T023826Z" DISK_EXECUTION_ISSUE=BUY-53302 bash scripts/run-buy-48198-disk-watchdog.sh`
   - Generated at: `2026-06-19T02:38:26.196Z`
   - Status: `PASS`
   - Snapshot: `data/buy-53302-disk-monitor-20260619T023826Z`

## Current disk state

- `df -Pk /paperclip/instances/default/workspaces` at `2026-06-19T02:38:26Z`
- Filesystem: `/dev/vda1`
- Used: `177025188` KB (`88%`)
- Available: `25009484` KB
- Approx free space: `23.9 GB`
- Watchdog thresholds:
  - Warning below `20 GB`
  - Critical below `5 GB`
