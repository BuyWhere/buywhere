# BUY-53544 worker node disk-space enforcement (WC cycle artifact cleanup)
...
```bash
REPORT_PATH="$PWD/reports/BUY-53544-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json" \
LOG_PATH="$PWD/reports/BUY-53544-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.log.jsonl" \
...
- Markdown report: `reports/BUY-53544-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.md`
- JSON report: `reports/BUY-53544-worker-node-disk-space-enforcement-wc-cycle-artifact-cleanup.json`
