# BUY-53198 worker node disk-space enforcement (WC cycle artifact cleanup)
...
2. Focused dry-run passed in a temporary workspace with stale `logs/worker-old.log` and `runs/old` fixtures.
3. Observed results:
