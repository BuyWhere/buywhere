...
router.get('/ai-plugin.json', (_req: Request, res: Response) => {
  res.json({
    ...
    description_for_human: 'Cross-border product catalog for AI agents. Search 381M+ products across Shopee, Lazada, Amazon, Walmart, and 20+ retailers in Singapore, US, and Southeast Asia.',
