...
const FAIL_LAG_MS = parseInt(
  process.env.REPLICA_FAIL_LAG_MS || String(Math.max(MAX_LAG_MS, Math.round(MAX_LAG_MS * 1.25)))
);
...
export function estimateReplicaLagMs(input: {
