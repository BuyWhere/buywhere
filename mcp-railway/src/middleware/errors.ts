...
const DEFAULT_MESSAGES: Record<string, string> = {
  ...
  MARKET_UNSUPPORTED: 'Country code is not supported by this tool. Supported codes vary by tool — check the inputSchema enum.',
...
export function sendPerMinuteLimitError(
  res: Response,
  tier: string,
  limit: number
): void {
