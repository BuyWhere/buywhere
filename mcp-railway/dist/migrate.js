...
async function runMigrations() {
  ...
  `;
    try {
        await config_1.db.query("SET statement_timeout = 60000");
        await config_1.db.query("SET lock_timeout = 4000");
        await config_1.db.query(DEDUP_DUPLICATE_PRODUCT_INDEXES);
  ...
  `;
    ...
    try {
        await config_1.db.query('ALTER TABLE query_log ADD COLUMN IF NOT EXISTS returned_product_ids text[]');
    ...
    try {
        await config_1.db.query(MERCHANTS_MIGRATION);
