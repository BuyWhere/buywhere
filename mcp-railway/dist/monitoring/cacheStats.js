...
exports.recordCacheHitLatency = recordCacheHitLatency;
exports.readCacheHitLatencyPercentiles = readCacheHitLatencyPercentiles;
...
async function recordCacheHitLatency(redis, latencyMs, bucketSeconds = BUCKET_SECONDS) {
    if (!redis || !redis.zadd || !redis.expire)
        return;
