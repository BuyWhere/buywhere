...
from backend.models.product import ApiKey, Product, ImageHash
...
from backend.schemas.product import ProductListResponse, ProductResponse, SearchSuggestionResponse, SearchSuggestion, AutocompleteResponse, AutocompleteSuggestion, FacetBucket, PriceFacetBucket, RatingFacetBucket, SearchFiltersResponse, FacetCounts
from backend.schemas.search_history import SearchHistoryListResponse, SearchHistoryEntry
from backend.affiliate_links import get_affiliate_url
from backend.services.currency import SUPPORTED_CURRENCIES, convert_price, get_rate_for_header
from app import cache
from backend.routers.search_i18n import translate_query
