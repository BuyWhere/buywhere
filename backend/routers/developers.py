...
from backend.auth import get_current_api_key, provision_api_key
from backend.cache import get_redis
from backend.database import get_db
from backend.models.product import ApiKey, Developer
from backend.rate_limit import limiter
from backend.request_logging import LOG_FILE
...
from backend.services import growth
from backend.services.analytics import post_hog
from backend.services.analytics.ga4 import track_signup_complete as track_ga4_signup
...
async def developer_signup(
    ...
    redirect_url = None
    from backend.models.growth import ExperimentAssignment
