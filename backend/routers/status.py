...
from backend.models.product import ApiKey, IngestionRun, Product
from backend.schemas.status import CatalogStatus, IngestionRunInfo, PlatformProductCount, ScraperHealthReport, SystemHealthReport, DiskSpaceStatus
from backend.rate_limit import limiter
from backend.services.scraper_health import get_scraper_health
from backend.services.health import get_db_health
from backend.services.disk_watchdog import get_last_check
...
async def get_disk_space_status(
    ...
    from backend.services.disk_watchdog import WARN_FREE_GB, CRITICAL_FREE_GB, CHECK_PATH
