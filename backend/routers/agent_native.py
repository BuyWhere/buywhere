...
from backend.models.product import ApiKey, Product
from app import cache
from backend.schemas.agent.search import AgentSearchQuery, AgentSearchResponse, AgentSearchResult
from backend.schemas.agent.compare import AgentPriceComparisonRequest, AgentPriceComparisonResponse, AgentPriceComparisonItem
from backend.schemas.agent.batch import AgentBatchLookupRequest, AgentBatchLookupResponse, AgentBatchLookupItem
...
async def agent_explore(
    ...
    if total == 0:
        from backend.schemas.agent.search import AgentSearchResponse
    ...
    for product in products:
        ...
        from backend.schemas.agent.search import AgentSearchResult
        search_result = AgentSearchResult(
            id=product.id,
            sku=product.sku,
            source=product.source,
