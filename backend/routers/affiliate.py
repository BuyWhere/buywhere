...
from backend.models.product import ApiKey, Click
from backend.rate_limit import limiter, rate_limit_from_request
from backend.affiliate_links import get_affiliate_url, is_valid_url
...
async def create_affiliate_link(
    ...
    if body.product_id and is_tracked:
        from backend.affiliate_links import _generate_tracking_id
