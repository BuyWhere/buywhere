...
CHECKPOINT_FILE = "data/shopify-batch-checkpoint-w2.json"
CANDIDATES_FILE = "data/us_shopify_batch_2.json"
LOG_FILE = f"data/shopify-batch-w2-{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}.log"
