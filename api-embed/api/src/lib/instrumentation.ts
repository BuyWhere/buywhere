 ...
 * BUY-71129 (re-applied, was clobbered by 554950c7): k + aid thread caller
 * attribution through to a browser click (which has no Bearer header). See
 * api/src/lib/instrumentation.ts for full rationale.
 */
